		...
		return <InstructionMessage>
			...
			<Tag name='frontend_guidance'>
				...
				<Tag name='design_instructions'>
					...
					- You do not use unsolicited visible, in-app text to describe the application's features, functionality, keyboard shortcuts, styling, visual elements, or how to use the application. When the user explicitly requests a dedicated help, docs, or about page, you implement that page.<br />
