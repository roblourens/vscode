...
suite('LocalAgentHostSessionsProvider', () => {
	...
	test('forwards a permission level picked while a new session commits to the committed session', async () => {
		...
		// Mode and sandbox share this sessionMutable replay path.
		...
		const pendingResolve = new DeferredPromise<void>();
		agentHost.resolveSessionConfigBarrier = pendingResolve;
