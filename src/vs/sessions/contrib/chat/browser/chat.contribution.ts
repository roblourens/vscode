...
import { SessionsChatAccessibilityHelp, SessionsChatAccessibleView } from './sessionsChatAccessibilityHelp.js';
...
AccessibleViewRegistry.register(new SessionsChatAccessibleView());
